Return JSON with keys: task_type, verification_required, verification_reason, task_category, entities, acceptance_criteria, risk_notes, search_hints, user_update.
